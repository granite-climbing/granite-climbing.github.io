...
import { getCragBySlug, getAllCrags, getBouldersByCrag, getAllProblemsByCrag, getAllCultureItems } from '@/lib/content';
  ...
  return (
    <>
      ...
      <main>
        ...
        />
        <CragDetailTabs crag={crag} boulders={boulders} problems={problems} cultureItems={cultureItems} />
      </main>
      <Footer />
    </>
  );
